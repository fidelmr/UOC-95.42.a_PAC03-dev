...
/* *********** LLISTAT / DETALL / COMBAT ********************** */
    ...
    .poke_tapa img{height: 20rem;}/*{width: 240px; height: 534px};*/
    .pImg img{height: 5rem;width: 50%;}/*{width: 240px; height: 534px};*/
    ...
    width: max-content;} /*width: 240px; height: 534px*/
...
position: relative; 
    ...
    .poke_tapa img {width: max-content;} /*width: 240px; height: 534px*/
    .poke_contingut{
    position:absolute;
    top:0;
    left:0;
